...
- [x] Initialize playwright and install project packages
  ...
  - [x] Use `npm run browser-install` to install the browser environment for testing ("Playwright does not support chromium-headless-shell on mac10.15"; Eric told me to skip while I work on getting a new MacBook)
